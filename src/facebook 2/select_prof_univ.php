<?php
	...
	echo '<form action="select_prof_dept.php" method="post" name="select_prof_univ">';
	...
	echo 'University: ';
	echo '<br />';
	createDropdown($name_arr, $univ_id_arr, 'prof_univ');
	echo '<br />';
	echo '<input type="submit" name="sub_prof_univ" value="Submit">';
