...
public interface UserToken
{
    ...
    /**
     * This method should return a string indicating the name of the
     * file server that this token will be used at.
     *
     * @return The name of the file server this token will be used at
     *
     */
    ...
    /**
     *
     * This extracts the token's signature to be decrypted and verified by
