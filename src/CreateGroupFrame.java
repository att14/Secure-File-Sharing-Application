...
/*
 * CreateGroupFrame.java
 *
 * Created on Feb 10, 2011, 10:10:10 AM
 *
 * @author CJ
 */
public class CreateGroupFrame extends ClientGUI {
    /** Creates new form CreateGroupFrame */
    public CreateGroupFrame(JFrame parent, UserToken token, GroupClient groupClient) {
        super(parent, token);
        parentFrame = parent;
        userToken = token;
        gClient = groupClient;
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addComponent(groupNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if(createSuccess){
            ...
            System.out.println("Failed to create group, disconnecting.");
            gClient.disconnect();
        }
